...
<div className="flex gap-2 px-4 mt-2">
  ...
  {/* Spending Info */}
<div className="px-4 py-3 mt-5 bg-white shadow rounded-lg" style={{ border: '1px solid #E5E7EB', marginLeft: '16px', marginRight: '16px' }}>
...
<div
  ...
  style={{ border: "1px solid #E5E7EB", marginLeft: "16px", marginRight: "16px" }}
>
